...
switch ($action) {
    ...
    //  include '../views/login.php';
      ...
      setcookie('firstname', $_SESSION['clientData']['clientFistname'],
      strtotime('+1 year'), "/");
...
case 'admin':
      ...
      $clientInfo = reviewsByUser($clientId);
      // var_dump($reviewsByUser($clientId));

      $reviewDisplay = "<div>";
      foreach($clientInfo as $clientI){
          $reviewDisplay .= "<div class='listReview'>&#187; 
          $clientI[invMake] $clientI[invModel] (Review date: $clientI[reviewDate]) <a href='../reviews/?action=editReview&invId=$clientI[invId]&clientId=$clientI[clientId]&reviewId=$clientI[reviewId]'>Edit</a> | <a href='../reviews/?action=deleteReview&invId=$clientI[invId]&clientId=$clientI[clientId]&reviewId=$clientI[reviewId]'>Delete</a></div>";
      }
      $reviewDisplay .= "</div>";
