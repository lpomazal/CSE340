...
$navList .= "<li><a href='/phpmotors/index.php?action=".urlencode($singleClass['classificationName'])."' title='View our $singleClass['classificationName'] product line'>$singleClass['classificationName']</a></li>";
}
$navList .= '</ul>';};
