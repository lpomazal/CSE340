    ...
    <div class="flexC">
        <div id="wrapper">
            ...
            <main>
                ...
                <?php 
                        $clientReviews = reviewsByUser($_SESSION['clientData']['clientId']);
                        if($clientReviews){
                           $reviews = reviewsByUser($clientId);
                           echo $reviews;     
                        }  
                ?>
                <a href="/phpmotors/reviews/index.php?action=reviewDisplay">Manage Your Reviews</a>
            </main>
            <hr>
            <footer>
