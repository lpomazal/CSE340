                ...
                <form action="/phpmotors/vehicles/index.php" method="post">
                    ...
                    <label>Vehicle Price
                        <input type="number" name="invPrice" placeholder="Vehicle Price No Symbols"
                            title="Can not be empty" pattern="[0-9]" <?php if(isset($invPrice)){echo "value='$invPrice'";} ?> required></label><br>
                    <label>Vehicle Stock
                    ...
                    <label>Vehicle Color
                        <input type="text" name="invColor" placeholder="Vehicle Color" title="Can not be empty" <?php if(isset($invColor)){echo "value='$invColor'";} ?> required></label><br>
