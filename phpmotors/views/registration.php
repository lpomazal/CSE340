            ...
            <main>
                ...
                <form action="/phpmotors/accounts/index.php" method="post">
                    ...
                    <label>First Name
                        ...
                        <input type="text" name="clientFirstname" placeholder="First Name" id="First Name" title="Can not be empty"
                            <?php if(isset($clientFirstname)){echo "value='$clientFirstname'";} ?> required></label><br>

                    <label>Last Name

                        <input type="text" name="clientLastname" placeholder="Last Name" id="Last Name" title="Can not be empty"
                            <?php if(isset($clientLastname)){echo "value='$clientLastname'";} ?> required></label><br>

                    <label>Email Address

                        <input type="email" name="clientEmail" placeholder="Email Address" id="Email Address" title="Can not be empty"
